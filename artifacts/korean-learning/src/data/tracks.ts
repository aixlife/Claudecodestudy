...
export const tracks: Track[] = [
  {
    ...
    color: '#3B82F6',
    hookCopy: {
      entry: '이 트랙을 끝까지 따라가면, 여러분만의 업무 자동화 도구가 실제로 동작합니다.',
      midpoint: '축하합니다. 방금 여러분이 만든 자동화가 처음으로 실행됐어요.',
  ...
  },
  {
    ...
    color: '#10B981',
    hookCopy: {
      entry: '이 트랙을 끝까지 따라가면, 여러분만의 웹사이트가 실제로 인터넷에 올라갑니다.',
      midpoint: '축하합니다. 방금 여러분이 만든 페이지예요.',
      completion: '여기까지 온 사람은 생각보다 많지 않습니다. 이제 여러분의 웹사이트가 세상에 있어요.',
    },
  ...
  },
  {
    ...
    color: '#8B5CF6',
    hookCopy: {
      entry: '이 트랙을 끝까지 따라가면, 여러분만의 데이터 대시보드가 실제로 동작합니다.',
      midpoint: '축하합니다. 방금 여러분이 만든 대시보드에 데이터가 표시되고 있어요.',
      completion: '여기까지 온 사람은 생각보다 많지 않습니다. 이제 데이터가 여러분에게 말을 걸어요.',
    },
  ...
  },
  {
    ...
    color: '#F59E0B',
    hookCopy: {
      entry: '이 트랙을 끝까지 따라가면, 여러분의 상상이 실제로 동작하는 프로젝트가 됩니다.',
      midpoint: '축하합니다. 지금 보고 있는 게 여러분이 만든 거예요.',
      completion: '여기까지 온 사람은 생각보다 많지 않습니다. 여러분은 이제 무엇이든 만들 수 있어요.',
    },
